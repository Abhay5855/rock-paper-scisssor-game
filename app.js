...
function frontEnd(humanImageChoice, botImageChoice, finalMessage) {
    ...
    humanDiv.innerHTML = "<img src='" + imgDB[humanImageChoice] + "' width=150 padding=10 style='box-shadow: 0px 10px  40px #2563EB'>" 


    messageDiv.innerHTML = "<h1 style = 'color: " + finalMessage['color'] + "; ' width=150 padding=10 >" + finalMessage['message'] + "</h1>" 

    botDiv.innerHTML = "<img src='" + imgDB[botImageChoice] + "' width=150 padding=10 style='box-shadow: 0px 10px  40px #DC2626'>" 
